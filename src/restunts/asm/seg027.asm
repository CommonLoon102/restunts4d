...
seg027 segment byte public 'STUNTSC' use16
    ...
    public ported_audio_check_flag_
...
ported_nopsub_37456_ proc far
    ...
    pop     bp
    retf
ported_nopsub_37456_ endp
ported_sub_37470_ proc far
    var_2 = word ptr -2
     s = byte ptr 0
     r = byte ptr 2
    arg_0 = word ptr 6
...
ported_audio_check_flag2_ proc far
    ...
    push    [bp+arg_0]
    push    cs
    call near ptr ported_audio_check_flag_
    add     sp, 0Ah
    pop     bp
    retf
    ; align 2
...
ported_audio_check_flag_ proc far
    var_6 = word ptr -6
    var_4 = word ptr -4
    var_2 = word ptr -2
     s = byte ptr 0
