...
loc_15E38:
    ...
    push    [bp+arg_pState]
    push    cs
    call near ptr ported_carState_rc_op_
    add     sp, 6
    mov     [bp+var_EE], ax
    cmp     pState_minusRotate_z_1, 0
    jnz     short loc_15E85
...
loc_170EC:
    push    cs
    call near ptr ported_audio_carstate_
    pop     si
    pop     di
    mov     sp, bp
    pop     bp
...
ported_audio_carstate_ proc far
    var_34 = dword ptr -52
    var_30 = word ptr -48
    var_2E = word ptr -46
    var_2C = word ptr -44
