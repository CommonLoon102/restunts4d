...
seg007 segment byte public 'STUNTSC' use16
    ...
    public ported_audio_driver_timer_
    public ported_audio_op_unk2_
    public ported_nopsub_27220_
    ...
    public ported_audio_op_unk5_
    public ported_audio_op_unk6_
...
ported_audio_remove_driver_timer_ proc far
     r = byte ptr 0

    jmp     audio_remove_driver_timer
    nop
loc_26BDB:
    cmp     byte ptr [si], 1
loc_26BDE:
...
ported_audio_driver_timer_ proc far
    var_4 = word ptr -4
    var_1 = byte ptr -1
     s = byte ptr 0
     r = byte ptr 2

    jmp     audio_driver_timer
    nop
    push    di
    push    si
    call    compare_ds_ss
...
loc_27127:
    ...
    ; align 2
    db 144
ported_audio_driver_timer_ endp
ported_audio_op_unk2_ proc far
    var_16 = word ptr -22
    var_14 = word ptr -20
    var_10 = word ptr -16
    var_E = word ptr -14
...
loc_27213:
    ...
    pop     bp
    retf
ported_audio_op_unk2_ endp
ported_nopsub_27220_ proc far
     s = byte ptr 0
     r = byte ptr 2
    arg_0 = word ptr 6
...
loc_27233:
    ...
    pop     bp
    retf
ported_nopsub_27220_ endp
ported_nopsub_2726C_ proc far
     s = byte ptr 0
     r = byte ptr 2
    arg_0 = word ptr 6
...
ported_audio_function2_wrap_ proc far
    ...
    pop     bp
    retf
ported_audio_function2_wrap_ endp
ported_audio_op_unk3_ proc far
     s = byte ptr 0
     r = byte ptr 2
    arg_0 = word ptr 6
    ...
    pop     bp
    retf
ported_audio_op_unk3_ endp
ported_audio_op_unk4_ proc far
     s = byte ptr 0
     r = byte ptr 2
    arg_0 = word ptr 6
    ...
    pop     bp
    retf
ported_audio_op_unk4_ endp
ported_audio_op_unk5_ proc far
    var_2 = word ptr -2
     s = byte ptr 0
     r = byte ptr 2
    arg_0 = word ptr 6
...
loc_273DB:
    ...
    pop     bp
    retf
ported_audio_op_unk5_ endp
ported_audio_op_unk6_ proc far
    var_2 = word ptr -2
     s = byte ptr 0
     r = byte ptr 2
    arg_0 = word ptr 6
...
loc_27436:
    ...
    pop     bp
    retf
ported_audio_op_unk6_ endp
ported_audio_op_unk7_ proc far
     s = byte ptr 0
     r = byte ptr 2
    arg_0 = word ptr 6
