...
ported_hiscore_draw_text_ proc far
     s = byte ptr 0
     r = byte ptr 2
    arg_0 = word ptr 6
    arg_2 = word ptr 8
...
ported_do_key_restext_ proc far
    ...
    call near ptr ported_input_pop_status_
    retf
ported_do_key_restext_ endp
ported_do_mou_restext_ proc far
    ...
    ; align 2
    db 144
ported_do_mou_restext_ endp
ported_do_pau_restext_ proc far
...
ported_do_sonsof_restext_ proc far

    jmp     do_sonsof_restext
    nop
    nop
    nop
    nop
...
loc_29F30:
    ...
    call near ptr ported_input_pop_status_
    retf
ported_do_sonsof_restext_ endp
ported_do_dos_restext_ proc far
