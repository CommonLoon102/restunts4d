...
seg012 segment byte public 'STUNTSC' use16
    ...
    public loc_33BF5
    public ported_nopsub_33D0C_
    public ported_sprite_shape_to_1_
    public ported_sprite_shape_to_1_alt_
    public loc_33D69
    public ported_nopsub_33DBE_
    public ported_shape2d_op_unk5_
    public ported_shape2d_op_unk_
    public loc_33E1B
    public loc_33E27
    public ported_nopsub_33E90_
...
ported_nopsub_33DBE_ proc far
    ...
    ; align 2
    db 144
ported_nopsub_33DBE_ endp
ported_shape2d_op_unk5_ proc far
    var_4 = word ptr -4
    var_2 = word ptr -2
     s = byte ptr 0
     r = byte ptr 2
    ...
    ; align 2
    db 144
ported_shape2d_op_unk5_ endp
ported_shape2d_op_unk_ proc far
    var_10 = word ptr -16
    var_E = word ptr -14
    var_6 = word ptr -6
    var_4 = word ptr -4
...
loc_33E8B:
    ...
    ; align 2
    db 0
ported_shape2d_op_unk_ endp
ported_nopsub_33E90_ proc far
    var_4 = word ptr -4
    var_2 = word ptr -2
     s = byte ptr 0
     r = byte ptr 2
...
ported_set_fontdefseg_ proc far
     s = byte ptr 0
     r = byte ptr 2
    arg_2 = word ptr 8
...
loc_35C43:
    ...
    ; align 2
    db 0
ported_sub_35B76_ endp
ported_sub_35C4E_ proc far
    var_14 = word ptr -20
    var_12 = word ptr -18
    var_10 = word ptr -16
    var_E = word ptr -14
