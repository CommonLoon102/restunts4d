...
enum BANKED_ENTRANCE_VARIANT {
	BANKED_ENTRANCE_A_VARIANT = 0,
	BANKED_ENTRANCE_B_VARIANT = 1
};
...
enum CORKSCREW_STATE {
	CORKSCREW_INACTIVE = 0,
	CORKSCREW_ACTIVE = 1
};
...
enum CORK_LR_VERTICAL_HALF {
	CORK_LR_LOWER_HALF = 0,
	CORK_LR_UPPER_HALF = 1
};
	...
	struct VECTOR* next_world_position)
{
	...
	} else if (terrain_tile >= TERRAIN_WATER_SLOPE_2 &&
		terrain_tile <= TERRAIN_WATER_SLOPE_5) {
		switch (terrain_tile) {
