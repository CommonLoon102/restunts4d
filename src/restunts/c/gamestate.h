...
#define RACE_START_SEQUENCE_INACTIVE 0
#define RACE_START_SEQUENCE_FLAG_ANIMATION 1
#define RACE_START_SEQUENCE_AUTO_DRIVE 2

#define GAMESTATE_INIT_NORMAL 0
#define GAMESTATE_INIT_RESET_CHECKPOINTS (-1)
#define GAMESTATE_INIT_SKIP_ROUTE_SETUP (-2)
#define GAMESTATE_INIT_TIMING_ONLY (-3)

#define TRANSMISSION_MANUAL 0
#define TRANSMISSION_AUTOMATIC 1

#define CAR_GEAR_CHANGE_INACTIVE 0
#define CAR_GEAR_CHANGE_ACTIVE 1
#define GEAR_CHANGE_DELAY_EXPIRED 0

#define CAR_PEDAL_RELEASED 0
#define CAR_PEDAL_PRESSED 1
#define CAR_SPEED_STOPPED 0
#define CAR_STEERING_CENTERED 0
#define CAR_WHEEL_HEADING_STRAIGHT 0
#define CAR_FRONT_WHEEL_ANGLE_STRAIGHT 0
#define CAR_ROTATION_ANGLE_ZERO 0
#define CAR_ROTATION_DELTA_NONE 0
#define CAR_SLIDE_ANGLE_NONE 0

#define CAR_SLIDING_INACTIVE 0
#define CAR_SLIDING_ACTIVE 1
#define CAR_WHEEL_CONTACT_NONE 0

#define CAR_COLLISION_LATCH_CLEAR 0
#define CAR_COLLISION_LATCH_SET 1
...
#define CRASH_EVENT_NONE 0
#define CRASH_EVENT_COLLISION 1
#define CRASH_EVENT_WATER 2
#define CRASH_EVENT_FINISH 3
#define CRASH_EVENT_EXIT 4
#define CRASH_EVENT_IMMEDIATE_STOP 5

#define ROUTE_INDICATOR_NONE 0
#define ROUTE_INDICATOR_LEFT 1
#define ROUTE_INDICATOR_RIGHT 2
#define ROUTE_INDICATOR_WRONG_WAY 3

#define ROUTE_TRACKING_NORMAL 0
#define ROUTE_TRACKING_OUTSIDE_TRACK 1
#define ROUTE_TRACKING_WRONG_WAY 2
#define ROUTE_CONFIRMATION_NONE 0
#define ROUTE_CONFIRMATION_INITIAL 1
#define ROUTE_CONFIRMATION_STEP 1
#define ROUTE_INDEX_NONE (-1)
#define ROUTE_POINT_FIRST 0
#define ROUTE_POINT_SECOND 1
