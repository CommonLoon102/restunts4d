...
{
	if (denominator == 0 || ((legacy_u16)numerator == LEGACY_U16_SIGN_BIT && denominator == -1)) {
		return 0;
	}
...
{
	if (denominator == (legacy_s32)0 || ((legacy_u32)numerator == (legacy_u32)LEGACY_U32_SIGN_BIT &&
