...
#define FRAME_CALLBACK_COUNTDOWN_INITIAL 1U
#define REPLAY_FRAME_INDEX_INITIAL 0U
#define REPLAY_EXIT_STATE_INITIAL 0U
#define START_FLAG_ANIMATION_INITIAL 0
...
{
	byte_44A8A = FRAME_CALLBACK_COUNTDOWN_INITIAL;
	byte_4552F = REPLAY_SLOW_CALLBACK_DIVISOR;
	elapsed_time2 = REPLAY_FRAME_INDEX_INITIAL;
	byte_449DA = REPLAY_EXIT_STATE_INITIAL;
	byte_4393C = RACE_START_SEQUENCE_INACTIVE;
	word_44DCA = START_FLAG_ANIMATION_INITIAL;
}
