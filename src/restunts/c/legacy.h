...
#define LEGACY_SHIFT_COUNT(value) \
	((legacy_u16)(value) & LEGACY_X86_SHIFT_COUNT_MASK)
#define LEGACY_ROTATE16_COUNT(value) \
	((legacy_u16)(value) & LEGACY_X86_ROTATE16_COUNT_MASK)
	...
	((legacy_u16)(LEGACY_SHIFT_COUNT(count) == 0U ? \
		...
		(((legacy_u16)(value) & LEGACY_U16_SIGN_BIT) != 0U ? \
			...
			(legacy_u16)((legacy_u32)LEGACY_U16_MAX << \
				(LEGACY_WORD_BITS - LEGACY_SHIFT_COUNT(count)))) : \
			(LEGACY_SHIFT_COUNT(count) >= LEGACY_WORD_BITS ? 0UL : \
			(legacy_u32)((legacy_u16)(value) >> \
				LEGACY_SHIFT_COUNT(count))))))
...
#define LEGACY_U16_SHL(value, count) \
	((legacy_u16)(LEGACY_SHIFT_COUNT(count) >= LEGACY_WORD_BITS ? 0UL : \
...
#define LEGACY_U16_MUL_HIGH(left, right) \
	((legacy_u16)(((legacy_u32)(legacy_u16)(left) * \
	(legacy_u32)(legacy_u16)(right)) >> LEGACY_WORD_BITS))
#define LEGACY_S16_MUL_HIGH(left, right) \
	LEGACY_S16_FROM_BITS((legacy_u16)LEGACY_U32_SAR((legacy_u32)( \
		...
		(legacy_s32)LEGACY_S16_FROM_BITS(right)), LEGACY_WORD_BITS))
...
#define LEGACY_WRITE_U16_LE(bytes, value) \
	do { \
		...
		(bytes)[1] = \
			(legacy_u8)(legacy_write_u16_value_ >> LEGACY_BYTE_BITS); \
	} while (0)
...
#define LEGACY_S32_FROM_BITS(value) \
	...
	(legacy_s32)(-1 - (legacy_s32)( \
		(legacy_u32)LEGACY_U32_MAX - (legacy_u32)(value))))
#endif

#define LEGACY_U32_SIGN_EXTEND_S16(value) \
	((legacy_u32)( \
		(((legacy_u16)(value) & LEGACY_U16_SIGN_BIT) != 0 ? \
		(legacy_u32)LEGACY_U32_HIGH_WORD_MASK : (legacy_u32)0) | \
		(legacy_u16)(value)))
...
#define LEGACY_WRITE_U32_LE(bytes, value) \
	do { \
		...
		(bytes)[1] = \
			(legacy_u8)(legacy_write_u32_value_ >> LEGACY_BYTE_BITS); \
		(bytes)[2] = \
			(legacy_u8)(legacy_write_u32_value_ >> LEGACY_WORD_BITS); \
		(bytes)[3] = \
			(legacy_u8)(legacy_write_u32_value_ >> LEGACY_THREE_BYTE_BITS); \
	} while (0)
